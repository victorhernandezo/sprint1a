...
import 'nutriologo_analitica_model.dart';
export 'nutriologo_analitica_model.dart';
...
class NutriologoAnaliticaWidget extends StatefulWidget {
  const NutriologoAnaliticaWidget({super.key});

  static String routeName = 'NutriologoAnalitica';
  static String routePath = '/nutriologoAnalitica';

  @override
  State<NutriologoAnaliticaWidget> createState() =>
      _NutriologoAnaliticaWidgetState();
}

class _NutriologoAnaliticaWidgetState extends State<NutriologoAnaliticaWidget> {
  late NutriologoAnaliticaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NutriologoAnaliticaModel());
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () {
              developer.log('IconButton pressed ...',
                  name:
                      'menu/nutriologo_analitica/nutriologo_analitica_widget.dart');
            },
          ),
          title: Text(
            'Analítica Chef',
