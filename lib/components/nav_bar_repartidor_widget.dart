...
import 'nav_bar_repartidor_model.dart';
export 'nav_bar_repartidor_model.dart';
...
/// 5.  Menu
class NavBarRepartidorWidget extends StatefulWidget {
  const NavBarRepartidorWidget({super.key});

  @override
  State<NavBarRepartidorWidget> createState() => _NavBarRepartidorWidgetState();
}

class _NavBarRepartidorWidgetState extends State<NavBarRepartidorWidget> {
  late NavBarRepartidorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavBarRepartidorModel());
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    context.pushNamed(CustomerMenuWidget.routeName);
                  },
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.center,
