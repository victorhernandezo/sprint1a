...
String? serializeParam(
  ...
  try {
    ...
    developer.log('Error serializing parameter: $e',
        name: 'flutter_flow/nav/serialization_util.dart');
    return null;
  }
}
  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case NutritionPlansRow:
            return NutritionPlansRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case NutritionistsRow:
            return NutritionistsRow(data);
          case DeliveriesRow:
            return DeliveriesRow(data);
          case DeliverersRow:
            return DeliverersRow(data);
          case DishesRow:
            return DishesRow(data);
          case DeliveryLocationsRow:
            return DeliveryLocationsRow(data);
          case OrderItemsRow:
    ...
    developer.log('Error deserializing parameter: $e',
        name: 'flutter_flow/nav/serialization_util.dart');
    return null;
  }
}
